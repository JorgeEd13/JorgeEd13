...
- 🎲 **Reproducible by construction** — same config + seed → **byte-identical** output (one seeded generator spawned per unit per stage); **102 offline tests**, ADR-documented, CI green. A future MLOps project will consume it as its data source.
